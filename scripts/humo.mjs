...
const CON_DEMO = [
  ...
  ['/seguimiento?tab=cargar', '2 · Compromisos, avances y problemas'],
...
const CON_SISTEMA_VACIO = [
  ...
  ['/monitoreo?secretaria=Secretar%C3%ADa%20de%20Salud', 'Sin monitoreos en el período'],
  ['/monitoreo?tab=cobertura', 'Secretarías sin cobertura'],
  ['/monitoreo?tab=cargar', 'Iniciar monitoreo'],
  ...
  ['/mesas?tipo=eventos&tab=checklist', 'Sin eventos pendientes'],
