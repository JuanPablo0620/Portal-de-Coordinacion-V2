...
const CAMPOS = [
  ...
  'fecha_cumplimiento, activo, creado_por, created_at, updated_at, id_responsable, id_reunion_equipo_origen',
...
const origenColumna = {
  ...
  equipo: 'id_reunion_equipo_origen',
};
