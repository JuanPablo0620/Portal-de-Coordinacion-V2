...
export function RegistrarReunion({ abierto, alCerrar, mesa }) {
  ...
  async function guardar() {
    ...
    for (const c of compromisos) {
      ...
      if (!c.id_responsable) { setError('Elegí el responsable de cada compromiso.'); return; }
        ...
        <fieldset className="rounded-chip border border-borde">
          ...
          <div className="flex flex-col gap-2 p-3">
            ...
            {compromisos.map((fila) => (
              ...
              <SelectorResponsable valor={fila.id_responsable} alCambiar={(id) => actualizarFila(fila.clave, 'id_responsable', id)} />
              <SelectorUnidad
                area={fila.area}
