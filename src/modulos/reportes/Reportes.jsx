...
function PanelFiltros({ filtros, setFiltros, limpiar, bd }) {
  ...
  return (
    <TarjetaFiltros
      ...
      alLimpiar={limpiar}
      desplegable
      descripcion="Todos combinables entre sí. Se reflejan en la dirección: esta configuración se comparte pegando el enlace. Usá una plantilla para abrir un informe ya preparado."
    >
